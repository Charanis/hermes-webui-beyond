...
- The actual Default Gateway runtime was alive as PID `75972` under `HERMES_HOME=/home/charanis/.hermes`, with `gateway.pid` and `gateway_state.json` pointing to that PID.
